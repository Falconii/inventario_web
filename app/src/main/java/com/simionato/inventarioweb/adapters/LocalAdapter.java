...
public class LocalAdapter extends ArrayAdapter {
    ...
    public LocalAdapter(Context context, int textViewResourceId, List<LocalModel> objects) {
    ...
    public View getOpcoesView(final int position, View convertView, ViewGroup parent) {
        ...
        tvCodigo.setText("Código: "+locais.get(position).getId());
        tvDescricao.setText(locais.get(position).getRazao());
