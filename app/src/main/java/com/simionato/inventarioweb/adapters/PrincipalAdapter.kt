...
class PrincipalAdapter(
    private val lista : List<PrincipalModel>,
    private val clique: (centro:PrincipalModel) -> Unit
    ) :
    RecyclerView.Adapter<PrincipalAdapter.PesquisaViewHolder>(),Filterable {
    ...
    inner class PesquisaViewHolder(val ItemView: View) : RecyclerView.ViewHolder(ItemView) {
        ...
        fun bind(centro:PrincipalModel){
    ...
    private val pesquisaFilter = object : Filter(){
        override fun performFiltering(constraint: CharSequence?): FilterResults {
            ...
            val resultList = ArrayList<PrincipalModel>()
        ...
        override fun publishResults(constraint: CharSequence?, results: FilterResults?) {
            ...
            val result = if (results?.values == null){
                ...
                results.values as ArrayList<PrincipalModel>
            }
            setNewData(result)
        }
    ...
    fun setNewData(data:List<PrincipalModel>){
